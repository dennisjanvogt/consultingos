      ...
      <div className="bg-gray-800 rounded-xl w-full max-w-lg max-h-[80vh] flex flex-col shadow-2xl">
        ...
        <div className="p-3 border-b border-gray-700">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
              autoFocus
            />
          </div>
        </div>
                ...
                <div className="space-y-1">
                  {shortcuts.map((shortcut, index) => (
                    ...
                    >
                      ...
                      <kbd className="px-2 py-0.5 bg-gray-900 border border-gray-600 rounded text-xs font-mono text-gray-300">
                        {shortcut.key}
                      </kbd>
                    </div>
                  ))}
        ...
        <div className="p-3 border-t border-gray-700 text-center">
          <p className="text-xs text-gray-500">
            Press <kbd className="px-1.5 py-0.5 bg-gray-900 border border-gray-600 rounded text-xs">Cmd+?</kbd> to toggle this dialog
          </p>
        </div>
      </div>
    </div>
