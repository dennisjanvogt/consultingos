    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">{t('invoices.title')}</h1>
          <button
...
function InvoiceRow({ invoice, statusStyles, formatCurrency, formatDate, onEdit, onDelete, onMarkPaid, onMarkSent, t }: InvoiceRowProps) {
